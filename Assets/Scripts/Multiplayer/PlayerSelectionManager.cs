...
public class PlayerSelectionManager : MonoBehaviour
{
    ...
    public void NextPlayer()
    {
        ...
        {
            playerModelType_Text.text = "Flapper";

        }
        else if (playerSelectionNumber == 1)
        {
            playerModelType_Text.text = "Trapper";

        }
        else if (playerSelectionNumber == 2)
        {
            playerModelType_Text.text = "Clapper";

        }
        else if (playerSelectionNumber == 3)
        {
            playerModelType_Text.text = "Zapper";
    ...
    public void OnSelectButtonClicked()
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable { { MultiplayerARGameStrings.PLAYER_SELECTION_NUMBER, playerSelectionNumber } };
